...
if [ -f "MainFrontend/frontend/env.example" ]; then
...
if [ -f "MainFrontend/frontend/src/components/TradingPairSelector.tsx" ]; then
...
if [ -f "MainFrontend/frontend/src/config/trading-pairs.ts" ]; then
...
if [ ! -f "MainFrontend/frontend/src/components/AddTradingPair.tsx" ]; then
...
echo "2. Start frontend: cd MainFrontend/frontend && npm run dev"
